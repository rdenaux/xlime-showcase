...
then
  ...
  deploy_ghpages () {
    # Deploying to GitHub Pages! (http://xlime-eu.github.io/xlime-showcase)
    echo Deploying to GitHub Pages
    sed -i.tmp "s/\/\/ app.baseUrl = '\/xlime-showcase/app.baseUrl = '\/xlime-showcase/" app/scripts/app.js
  ...
  deploy_firebase () {
    # Deploying to Firebase! (https://xlime-showcase.firebaseapp.com)
    ...
    gulp
    # Starting Deploy Process to Firebaseapp.com Server -- xlime-showcase.firebaseapp.com
